...
from CH12.PathFollower import PathFollower
from CH12.PathManager import PathManager
from CH12.PathPlanner import PathPlanner
from CH12.CreateWorld import CreateWorld
from CH12.RRT import RRT
...
class MAVModel(QWidget):
    def __init__(self, parent = None):
        ...
        self.view_thread.draw_buildings(self.world)
        ...
        self.rrt = RRT(self.world, self.view_thread, self.path_manager)
        self.waypoints = self.rrt.find_path()
    ...
    def control(self):
        ...
        # measured_states = np.array([[self.kalman_loc[0]], [self.kalman_loc[1]], [-self.sensor_values[6]],
        #                            [0], [0], [0],
        ...
        #                                  [0], #beta*
        #                                  [0], #path angle
        #                                  [self.kalman_loc[6]]]) #course angle*
